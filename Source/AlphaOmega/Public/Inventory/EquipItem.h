 ...
 */
UCLASS()
class ALPHAOMEGA_API UEquipItem : public UItem
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class ALPHAOMEGA_API UEquipItem_Clothing : public UEquipItem
{
	GENERATED_BODY()
...
/**
 * Defines a weapon item. Will use the skeletal mesh set in your EquipmentComponent and set it to the clothing mesh you select.
 */
UCLASS()
class ALPHAOMEGA_API UEquipItem_Weapon : public UEquipItem
{
	GENERATED_BODY()
