...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnEndLooting, class UInventoryComponent*, LootSource);
...
public:
	...
	TSoftClassPtr<class UItem> Item;
 ...
 */
UCLASS()
class ALPHAOMEGA_API UItemCollection : public UDataAsset
{
	GENERATED_BODY()
...
UCLASS( ClassGroup=(AlphaOmega),  DisplayName = "Game Inventory", meta=(BlueprintSpawnableComponent) )
class ALPHAOMEGA_API UInventoryComponent : public UActorComponent
{
	GENERATED_BODY()
...
public:	
	...
	virtual FItemAddResult TryAddItemFromClass(TSubclassOf<class UItem> ItemClass, const int32 Quantity = 1, const bool bCheckAutoUse=true);
	...
	UFUNCTION(BlueprintCallable, Category = "Inventory")
	virtual int32 ConsumeItem(class UItem* Item, const int32 Quantity = 1);
	...
	UFUNCTION(BlueprintCallable, Category = "Inventory")
	virtual bool RemoveItem(class UItem* Item);
	...
	virtual bool HasItem(TSoftClassPtr<class UItem> ItemClass, const int32 Quantity = 1, const bool bCheckVisibility = false) const;
	...
	UFUNCTION(BlueprintPure, Category = "Inventory")
	UItem* FindItemByClass(TSoftClassPtr<class UItem> ItemClass, const bool bCheckVisibility = false) const;

	/**Get all inventory items that are children of the supplied ItemClass. */
	UFUNCTION(BlueprintPure, Category = "Inventory")
	TArray<UItem*> FindItemsOfClass(TSubclassOf<class UItem> ItemClass, const bool bCheckVisibility = false) const;
...
protected:
	...
	virtual FItemAddResult TryAddItem_Internal(TSubclassOf<class UItem> ItemClass, const int32 Quantity = 1);
