...
UCLASS( ClassGroup=(AlphaOmega), Blueprintable, DisplayName = "Game Interactable", meta=(BlueprintSpawnableComponent) )
class ALPHAOMEGA_API UInteractableComponent : public UActorComponent
{
	GENERATED_BODY()
