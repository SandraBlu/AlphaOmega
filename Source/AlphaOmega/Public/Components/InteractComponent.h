...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnFoundReactor,class  UInteractableComponent*, Interactable );
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnLostReactor, class  UInteractableComponent*, Interactable);

DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FOnInteracted, class  UInteractComponent*, Interact, class  UInteractableComponent*, Interactable);
...
UCLASS( ClassGroup=(AlphaOmega), DisplayName = "Interact Comp", meta=(BlueprintSpawnableComponent) )
class ALPHAOMEGA_API UInteractComponent : public UActorComponent
{
	GENERATED_BODY()
...
protected:
	...
	void FoundInteractable(UInteractableComponent* Reactor);
